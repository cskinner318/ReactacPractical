...
namespace Reactec.Web.Validators
{
    ...
    public class WebUserValidator : AbstractValidator<WebUser>
    {
        ...
        public WebUserValidator()
        {
            ...
            this.RuleFor(x => x.Name).NotNull().WithMessage("Name is required");
            this.RuleFor(x => x.EmailAddress).NotNull().EmailAddress().WithMessage("Valid email address is required");
        }
    }
}
